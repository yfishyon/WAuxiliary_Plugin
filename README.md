...
| 插件                                      | API                                | 类型 | 状态 |
|-----------------------------------------|------------------------------------|----|----|
| [摸头插件@Hd](plugins/v126/Hd/Avatar-rua)   | [维梦API](https://api.52vmy.cn/)     | 免费 | ✅  |
| [表情合成@Hd](plugins/v126/Hd/EmojiMix)     | [晴天API](https://sbtxqq.com/)       | 免费 | ✅  |
| [历史今天@Hd](plugins/v126/Hd/HistoryToday) | [未知](https://v2.xxapi.cn/)         | 免费 | 🚫 |
| [点歌插件@Hd](plugins/v126/Hd/MusicPlugin)  | [落月API](https://doc.vkeys.cn/)     | 免费 | ✅  |
| [文转音@Hd](plugins/v126/Hd/TextToSpeech)  | [轩心云API](https://www.yx520.ltd/)   | 免费 | ✅  |
| [视频插件@Hd](plugins/v126/Hd/VideoPlugin)  | [未知](https://www.hhlqilongzhu.cn/) | 免费 | 🚫 |
